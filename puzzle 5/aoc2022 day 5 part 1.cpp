...
void execute(deque<deque<string>>& containers, int indextomove, int first_stack_pos, int second_stack_pos) {
...
int main() {
    ...
    while(getline(my_file, line)){
        ...
        for (int i = 0; i < indextomove; i++) {
            ...
            switch(second_stack) {
                case 1:
                    s1.push_front(transfer);
                    break;
                case 2:
                    s2.push_front(transfer);
                    break;
                case 3:
                    s3.push_front(transfer);
                    break;
                case 4:
                    s4.push_front(transfer);
                    break;
                case 5:
                    s5.push_front(transfer);
                    break;
                case 6:
                    s6.push_front(transfer);
                    break;
                case 7:
                    s7.push_front(transfer);
                    break;
                case 8:
                    s8.push_front(transfer);
                    break;
                case 9:
                    s9.push_front(transfer);
                    break;
